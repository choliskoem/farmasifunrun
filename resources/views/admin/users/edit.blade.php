...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-black text-slate-900">Edit Admin</h1>
    ...
    <div class="max-w-xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6 p-6 md:p-8">
            ...
            <div>
                ...
                <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="role" value="super_admin" class="peer sr-only" {{ old('role', $user->role) === 'super_admin' ? 'checked' : '' }}>
                        <div class="rounded-xl border border-slate-300 p-4 transition peer-checked:border-emerald-500 peer-checked:bg-emerald-50">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button class="rounded-xl bg-emerald-600 px-6 py-3 font-bold text-white transition hover:bg-emerald-700">Simpan Perubahan</button>
            </div>
