    ...
    <form
        ...
        <div class="mt-5">
            ...
            <textarea
                ...
                rows="6"
                required
                class="mt-2 w-full rounded-xl border-slate-200 px-4 py-3">{{ old('isi', $mission->isi) }}</textarea>
        ...
        <div class="mt-5 flex items-center gap-3">
            ...
            <input
                ...
                id="aktif"
                value="1"
                {{ old('aktif', $mission->aktif) ? 'checked' : '' }}
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <a
                ...
                class="rounded-xl border border-slate-200 px-5 py-3 text-sm font-bold">
